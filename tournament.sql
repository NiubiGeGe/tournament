...
-- create table players(player_id serial primary key, name text, matches integer DEFAULT 0);
...
-- create table pairing(pairing_id serial primary key, player_1 integer references players(player_id), player_2 integer references players(player_id));